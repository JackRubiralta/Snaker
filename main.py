...
snakes_hamiltonian_cycle = [
    DOWN, LEFT, LEFT, LEFT, LEFT, LEFT, LEFT, LEFT, LEFT, LEFT, LEFT, LEFT, LEFT, LEFT, LEFT,
    ...
    RIGHT, RIGHT, RIGHT, RIGHT, RIGHT, RIGHT, RIGHT, RIGHT, RIGHT, RIGHT, RIGHT, RIGHT, RIGHT, RIGHT, UP,
]
...
def generatePathToFood(hamiltonian_cycle):
    ...
    path_to_food = [snake.head] # added snake.head maybe makes it faster
...
def improveSnakesHamiltonianCycle():
    ...
    for tile in path_to_food:
        match snakes_hamiltonian_cycle[tile]:
            case directions.UP: # UP
                ...
                # maybe also check if endge_tile is == snake.food
    ...
    for shortcutted_hamiltonian_cycle in shortcutted_hamiltonian_cycles:
        shortcutted_hamiltonian_cycle_length = len(generatePathToFood(shortcutted_hamiltonian_cycle))
        if shortcutted_hamiltonian_cycle_length < shortest_path_length:
            snakes_hamiltonian_cycle = shortcutted_hamiltonian_cycle 
            shortest_path_length = shortcutted_hamiltonian_cycle_length


    # could have something where I keep generating shortcutted_hamiltonian_cycles from shortcutted_hamiltonian_cycles
    # increases in size expo
    # i do this until when I generate a new batch from the batch of all of the ones generated last time I find 
    # no shortcutted_hamiltonian_cycles which is faster not equal to
    # then I just make the new snakes_hamiltonian_cycle the fastest one
